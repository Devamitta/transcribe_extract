#!/bin/bash
# Full Russian YouTube pipeline (audio-input mode).
# Usage: ./yt_run_russian.sh [folder]   default folder: russian
set -e
...
uv run python scripts/yt_image_gen.py --lang ru --folder "$FOLDER"
