...
def get_semantic_eval_instruction() -> str:
    ...
    return (
        ...
        "DO NOT FLAG:\n"
        "- Informal or casual speech ('so kind of coming back to...', 'some mixed up part')\n"
        ...
        "- Valid doctrinal statements even if simply or informally phrased\n"
        "- Grammar imperfections: missing articles, wrong verb agreement, informal syntax — these are spoken speech, not Whisper errors\n"
        ...
        "- Nonsense proper nouns that are clearly garbled names or terms (e.g. 'Chipsy Biddy', 'double-dog')\n"
